...
$('#page-videos').live("pagecreate", function() {
...
function showMyVideos(data) {
	...
	var html = [ '' ];
	if(entries.length ==0){
		document.getElementById("videoResultsDiv").innerHTML = 'No video found ...';
	}else{	
	...
	for ( var i = 0; i < entries.length; i++) {
		...
		html.push('<div data-role="fieldcontain" style="font-size: 1em; margin-left: auto; margin-right: auto; width: 100%; text-align: center;"><p>',
						title,
						'<\p><iframe class="youtube-player" type="text/html" width="270" height="152" frameborder="0" id="',
						id, '" src="', lnk, '"></iframe></div>');
		document.getElementById("videoResultsDiv").innerHTML = html.join('');
		// this sets the id of the object or embed tag to 'myytplayer'.
		// You then use this id to access the swf and make calls to the player's
		// API
